...
class TLSSigAPI {
     ...
     * @param uint $expire usersig有效期 默认为180天 180*24*3600
...
try{
    $api = new TLSSigAPI();
    $api->SetAppid(1400008634);
    $private = file_get_contents('../key/private_key');
    $api->SetPrivateKey($private);
    $public = file_get_contents('../key/public_key');
    $api->SetPublicKey($public);
    echo $sig = $api->genSig('terry1986');exit;
